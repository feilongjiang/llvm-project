...
bool Cpu0SEFrameLowering::hasReservedCallFrame(
  ...
  // Reserve all frame if the size of the maximum call frame fits into 16-bit
...
// physical registers used to determine what callee saved regsiters should be
// spilled. This method is optional.
void llvm::Cpu0SEFrameLowering::determineCalleeSaves(MachineFunction &MF,
                                                     BitVector &SavedRegs,
