...
static cl::opt<bool> EnableOverflowOpt(
    "cpu0-enable-overflow", cl::init(false),
...
static cl::opt<bool> UseSmallSectionOpt(
    "cpu0-use-small-section", cl::init(false),
    cl::desc("Use small section. Only work when -relocation-model="
             "static. pic always not use small section."),
    cl::Hidden);

static cl::opt<bool> ReserveGPOpt("cpu0-reserve-gp", cl::init(false),
                                  cl::desc("Never allocate $gp to variable"),
                                  cl::Hidden);

static cl::opt<bool> NoCploadOpt("cpu0-no-cpload", cl::init(false),
                                 cl::desc("No issue .cpload"), cl::Hidden);
...
Cpu0Subtarget::initializeSubtargetDependencies(StringRef CPU, StringRef FS,
  ...
  // Initialize scheduling itineraries for the specified CPU.
